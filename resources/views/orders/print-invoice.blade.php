...
{{--                                            @foreach ($orderDetails as $item)--}}
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    {{ Number::currency($item->unitcost, 'XAF') }}
                                                </td>
                                                <td class="align-middle text-center">
                                                    {{ $item->quantity }}
                                                </td>
                                                <td class="align-middle text-center">
                                                    {{ Number::currency($item->total, 'XAF') }}
                                                </td>
                                            </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <strong>
                                                        {{ Number::currency($order->sub_total, 'XAF') }}
                                                    </strong>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <strong>
                                                        {{ Number::currency($order->total, 'XAF') }}
                                                    </strong>
                                                </td>
                                            </tr>
                                        </tbody>
